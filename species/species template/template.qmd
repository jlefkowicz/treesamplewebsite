...
* Bark is light gray to almost white in color and has a flaky-like appearance. 2 different types of bark patterns on the lower trunk can be seen:
  ...
  * Blocky bark pattern:
  ...
  ![](bark_blocky.jpeg){width=200px height=250px}
  ...
  * Flaky bark pattern with long plates, resembling shingles
  ...
  ![](bark_flaky.png){width=200px height=250px}
...
* Rely heavily on animals for the dispersal of their acorns, especially gray squirrels and eastern chipmunks via scatter hoarding (collecting and burying acorns for future use)
